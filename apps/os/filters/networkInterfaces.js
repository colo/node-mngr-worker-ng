const debug = require('debug')('filter:os-networkInterfaces');
const debug_internals = require('debug')('filter:os-networkInterfaces:Internals');
...
module.exports = function(doc, opts, next, pipeline){
	...
	let val = doc.data.networkInterfaces
	let host = doc.host
	let module = doc.module

	debug('networkInterfaces %o', val)
	// process.exit(1)
