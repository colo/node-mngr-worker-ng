...
const debug = require('debug')('Server:Apps:Educativa:Size:Filter:Installs'),
      debug_internals = require('debug')('Server:Apps:Educativa:Size:Filter:Installs:Internals')
