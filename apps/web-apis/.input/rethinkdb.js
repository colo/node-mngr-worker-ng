...
let debug = require('debug')('Server:Apps:Web-Apis:AbuseIPDB:Input'),
    debug_internals = require('debug')('Server:Apps:Web-Apis:AbuseIPDB:Input:Internals');
...
module.exports = new Class({
  ...
  ID: 'de6aefa8-1026-4a31-8b24-c88707f62a62',
  // registered: {},
  // registered_ids: {},
  // feeds: {},
  // close_feeds: {},
