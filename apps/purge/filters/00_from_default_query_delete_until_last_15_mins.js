...
let debug = require('debug')('Server:Apps:Purge:Filters:from_default_query_delete_until_last_15_mins');
let debug_internals = require('debug')('Server:Apps:Purge:Filters:from_default_query_delete_until_last_15_mins:Internals');
