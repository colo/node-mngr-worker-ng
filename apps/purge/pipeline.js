...
const debug = require('debug')('Server:Apps:Purge:Pipeline'),
      debug_internals = require('debug')('Server:Apps:Purge:Pipeline:Internals')
...
//   input)
//
//   clients_conf.clients = input.clients
//
//   let conf = {
//     input: [
//       new JSPipelineInputClients(clients_conf)
//
//     ],
//
//     filters: filters,
