          ...
          periodical: {
            ...
            query: {
              ...
              'filter': [
                ...
                "this.r.row('metadata').hasFields('domain').and(this.r.row('metadata')('path').eq('logs.qmail.send'))"
              ]
              // 'filter': [
              //   /**
              //   * don't use this domains:
              //   * 'status'
              //   * 'msg.new'
              //   * 'msg.end'
              //   **/
              //   "this.r.row('metadata').hasFields('domain').and(this.r.row('metadata')('path').eq('logs.qmail.send').and("+
              //   "this.r.row('metadata')('domain').ne('status').and("+
              //   "this.r.row('metadata')('domain').ne('msg.new').and("+
              //   "this.r.row('metadata')('domain').ne('msg.end')"+
              //   "))))"
              // ]
            }
          }
